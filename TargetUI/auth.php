...
<div class="centering auth-pos">
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
		<div class="container text-center form-container">
			...
			<button class="btn btn-primary cust-btn auth" type="button" onclick="window.location ='index.php'" style="margin-top: 20px; background-color: maroon">Exit</button>
			</div>		
		</div>
	</form>
</div>
